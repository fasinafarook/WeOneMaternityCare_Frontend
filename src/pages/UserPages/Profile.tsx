      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ padding: '30px', display: 'grid', gap: '20px' }}>
            ...
            <form onSubmit={handleSubmitProfile(saveProfileChanges)} style={{ display: 'grid', gap: '20px' }}>
              <h3 style={{
                fontSize: '22px',
                fontWeight: '600',
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                <div>
                  <label htmlFor="name" style={{ display: 'block', fontSize: '14px', fontWeight: '500' }}>Name</label>
                  <div style={{ position: 'relative' }}>
                    <FaUser style={{ position: 'absolute', top: '50%', left: '10px', transform: 'translateY(-50%)', color: '#999' }} />
                    <input
                      type="text"
                      id="name"
                    ...
                    />
                    {profileError.name && <p style={{ color: 'red', fontSize: '12px' }}>{profileError.name.message}</p>}
                  </div>
                </div>

                <div>
                  <label htmlFor="email" style={{ display: 'block', fontSize: '14px', fontWeight: '500' }}>Email</label>
                  <div style={{ position: 'relative' }}>
                    <FaEnvelope style={{ position: 'absolute', top: '50%', left: '10px', transform: 'translateY(-50%)', color: '#999' }} />
                    <input
                      type="email"
                      id="email"
                      readOnly
                ...
                <div>
                  <label htmlFor="mobile" style={{ display: 'block', fontSize: '14px', fontWeight: '500' }}>Mobile</label>
                  <div style={{ position: 'relative' }}>
                    <FaPhone style={{ position: 'absolute', top: '50%', left: '10px', transform: 'translateY(-50%)', color: '#999' }} />
                    <input
                      type="tel"
                      id="mobile"
                    ...
                    />
                    {profileError.mobile && <p style={{ color: 'red', fontSize: '12px' }}>{profileError.mobile.message}</p>}
                  </div>
                </div>
              </div>
            ...
            {/* Change Password */}
            <form onSubmit={handleSubmitPassword(changePassword)} style={{ display: 'grid', gap: '20px' }}>
              <h3 style={{
                fontSize: '22px',
                fontWeight: '600',
                borderBottom: '2px solid #ddd',
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                <div>
                  <label htmlFor="currentPassword" style={{ display: 'block', fontSize: '14px', fontWeight: '500' }}>Current Password</label>
                  <div style={{ position: 'relative' }}>
                    <FaLock style={{ position: 'absolute', top: '50%', left: '10px', transform: 'translateY(-50%)', color: '#999' }} />
                    <input
                      type="password"
                      id="currentPassword"
                    ...
                    />
                    {passwordError.currentPassword && <p style={{ color: 'red', fontSize: '12px' }}>Current Password is required</p>}
                  </div>
                </div>

                <div>
                  <label htmlFor="newPassword" style={{ display: 'block', fontSize: '14px', fontWeight: '500' }}>New Password</label>
                  <div style={{ position: 'relative' }}>
                    <FaLock style={{ position: 'absolute', top: '50%', left: '10px', transform: 'translateY(-50%)', color: '#999' }} />
                    <input
                      type="password"
                    ...
                    />
                    {passwordError.newPassword && <p style={{ color: 'red', fontSize: '12px' }}>New Password is required</p>}
                  </div>
                </div>
              </div>
              <div style={{ textAlign: 'right' }}>
