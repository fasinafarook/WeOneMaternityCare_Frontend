...
const ForgotPassword: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: `url('https://www.healthymummy.com/wp-content/uploads/2016/10/Pregnant-woman-in-hospital-1.jpg')`,
    }}>
      <Link to="/">
        <img src={logo} alt="Logo" className="absolute top-6 left-6 w-24 h-auto" />
      </Link>
      <div className="bg-white bg-opacity-90 rounded-2xl shadow-2xl p-8 max-w-md w-full">
        ...
        <div className="mt-6 text-center">
          <Link to="/user/verify-login" className="text-sm font-medium text-indigo-600 hover:text-indigo-500">
    ...
    <div>
      ...
      <div className="mt-1">
        <input
          ...
          className={`appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm ${errors.email ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
  ...
  <div>
    ...
    <div className="mt-1">
      <input
        ...
        className={`appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm ${errors[id] ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
