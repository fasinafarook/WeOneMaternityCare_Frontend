...
import { useEffect, useState, useCallback } from "react";
import { getSchedulesBookings, processRefund, updateBookingStatus, notifyLeaveAndRefund } from "../../api/serviceProviderAPI";
import { useNavigate, useSearchParams } from "react-router-dom";
import { FaRegClock } from "react-icons/fa";
import { MdVideoCameraBack } from "react-icons/md";
import Pagination from "../../components/common_pages/Pagination";
...
{/* Reason Input Modal */}
<Dialog open={showReasonInputModal} onClose={() => setShowReasonInputModal(false)}>
