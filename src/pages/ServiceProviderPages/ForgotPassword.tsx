...
<Link to="/">
      ...
      />
    </Link>            <div className="flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
        <div className="w-full relative mt-20 max-w-md space-y-8">
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <div className="mt-6 text-center">
              <Link to="/serviceProvider/verify-login" className="text-sm font-medium text-indigo-600 hover:text-indigo-500">
