...
const PaymentsDashboard = () => {
  ...
  const labels = transactionHistory.map((bookings) =>
    new Date(bookings.date).toLocaleDateString("en-IN", {
      day: "2-digit",
      month: "short",
    })
  );
                ...
                <tbody>
                  {currentTransactions.map((transaction, index) => (
                    <tr key={index} className="border-b hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4">
                        {transaction.user.name.toUpperCase()}{" "}
                      </td>
                      <td className="py-3 px-4">
                        {new Date(transaction.fromTime).toLocaleTimeString(
                          "en-IN",
                          { hour: "2-digit", minute: "2-digit" }
                        )}{" "}
                        -
                        {new Date(transaction.toTime).toLocaleTimeString(
                          "en-IN",
                          { hour: "2-digit", minute: "2-digit" }
                        )}
                      </td>
          ...
          <div className="bg-white shadow-lg rounded-lg p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-600">
                  Click on the 'Withdraw Funds' button in the dashboard and
              ...
              <div>
                ...
                <p className="text-gray-600">
                  ...
                  <a
                    ...
                    className="text-[#19328F] hover:underline"
                  >
                    support@materninty.com
                  </a>
                </p>
              </div>
            </div>
