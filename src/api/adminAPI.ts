...
export const getUsers = async (page: number, limit: number) => {
    try {
        const response = await Api.get(adminEndpoint.getUsers + `?page=${page}&limit=${limit}`);
...
export const getServiceProviders = async (page: number, limit: number) => {
    try {
        const response = await Api.get(adminEndpoint.getServiceProviders + `?page=${page}&limit=${limit}`);
        return response.data
    } catch (error) {
...
export const getServiceProviderDetails = async (id: string) => {
    try {
        const response = await Api.get(adminEndpoint.getServiceProviderDetails+`/${id}`)
...
export const approveServiceProvider = async (serviceProviderId: string) => {
    try {
        const response = await Api.put(adminEndpoint.approveServiceProvider+`/${serviceProviderId}`)
        return response
    } catch (error) {
...
export const blockProvider = async (serviceProviderId: string) => {
    try {
        const response = await Api.put(adminEndpoint.blockProvider+`/${serviceProviderId}`)
        return response.data
    } catch (error) {
        console.log("Error blocking user", error)
    }
...
export const addCategory = async (categoryData: categoryData) => {
    try {
        ...
        const response = await Api.post(adminEndpoint.addCategory, {categoryName, subCategories})
        return response.data
    } catch (error: any) {
...
export const getCategorys = async (page: number, limit: number) => {
    try {
        const response = await Api.get(adminEndpoint.getCategorys + `?page=${page}&limit=${limit}`)
        return response.data
    } catch (error) {
...
export const unlistCategory = async (categoryId: string) => {
    try {
        const response = await Api.put(adminEndpoint.unlistCategory + `/${categoryId}`)
...
export const getBlogs = async (page: number, limit: number) => {
    try {
        const response = await Api.get(adminEndpoint.getBlogs + `?page=${page}&limit=${limit}`);
...
export const updateBlogStatus = async (blogId: string, isListed: boolean) => {
    try {
        const response = await Api.put(`${adminEndpoint.updateBlogStatus}/${blogId}`, { isListed });
        return response.data;
    } catch (error) {
...
export const getWebinars = async (page: number, limit: number) => {
    try {
        const response = await Api.get(adminEndpoint.getWebinars + `?page=${page}&limit=${limit}`);
...
export const toggleWebinarListing = async (webinarId: string, isListed: boolean) => {
    try {
        const response = await Api.put(adminEndpoint.toggleWebinarListing + `/${webinarId}`, { isListed: !isListed });
        return response.data;
    } catch (error) {
...
export const unlistWebinar = async (webinarId: string) => {
    try {
        const response = await Api.put(adminEndpoint.unlistWebinar + `/${webinarId}`);
        return response.data;
    } catch (error) {
